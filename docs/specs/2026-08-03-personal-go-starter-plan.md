...
## Task 3 — Add repeatable local setup and demo seed
...
## Task 4 — Complete Personal operations baseline
...
## Task 5 — Harden identity, media and localization
...
## Task 6 — Prove the public CMS flow
